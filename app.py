...
with app.app_context():
    ...
    # Make the Rick account the owner/developer automatically.
    # It works by username "Rick" and also by the optional DEVELOPER_PHONE variable.
    ...
    if rick and not rick.is_developer:
        ...
        changed = True
    if phone_owner and not phone_owner.is_developer:
        phone_owner.is_developer = True
        changed = True
    if changed:
        db.session.commit()
