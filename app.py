...
h1,h2,h3{margin-top:0}.muted{color:#9db0c9}.badge{display:inline-block;background:#f4c542;color:#151515;padding:3px 8px;border-radius:999px;font-size:12px;font-weight:bold}
.badge.blue{background:#2589ff;color:#fff}.badge.mod{background:#8b5cf6;color:#fff}.actions{display:flex;gap:10px;flex-wrap:wrap;margin-top:16px}.btn.big{padding:14px 18px;border-radius:14px}.btn.purple{background:#7c3aed}.btn.blue{background:#2589ff}.btn.green{background:#27b978}.btn.red{background:#c94343}
...
.award-form{display:flex;gap:6px;align-items:center}.award-form input{width:100px;padding:8px}.small{font-size:13px}.hero{padding:35px 20px;text-align:center;background:linear-gradient(135deg,#0d1b2e,#123a46);border-radius:20px}
